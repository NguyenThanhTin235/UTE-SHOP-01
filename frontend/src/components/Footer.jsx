    ...
    <footer className="bg-[#f7f9ff] border-t border-[#c3c6d7] mt-24 font-sans">
      <div className="w-full py-12 px-4 md:px-10 mt-auto flex flex-col md:flex-row justify-between items-start max-w-[1280px] mx-auto gap-12">
        <div className="max-w-xs space-y-6">
          <Link to="/" className="font-sans text-2xl text-primary tracking-tight font-extrabold block">UTEShop</Link>
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-12 flex-grow">
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-3 text-sm text-[#434655]">
              <li><Link className="hover:text-primary transition-all" to="#">About Us</Link></li>
              <li><Link className="hover:text-primary transition-all" to="#">Careers</Link></li>
              <li><Link className="hover:text-primary transition-all" to="#">Terms of Service</Link></li>
            </ul>
          </div>
          <div className="col-span-2 md:col-span-1 space-y-4">
            ...
            <div className="flex gap-4">
              ...
              <a className="w-10 h-10 flex items-center justify-center rounded-full bg-[#e1e4f5] text-[#434655] hover:bg-primary hover:text-white transition-all shadow-sm" href="#"><span className="material-symbols-outlined text-[20px]">alternate_email</span></a>
