...
const adminLogisticsController = require('../../controllers/admin/adminLogisticsController');
const adminUIController = require('../../controllers/admin/adminUIController');
...
const adminPlatformSettingController = require('../../controllers/admin/adminPlatformSettingController');
